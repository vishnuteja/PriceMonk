...
<body>
		<%
			...
			session.setAttribute("Department", "Multimedia");
			...
			{	
						...
						String query = " select P.title, P.imgURL, M.*, min(S.price+S.SPrice) from Products P,media M, Sellers S where P.productID = '"+mediaID+"' and M.productID = '"+mediaID+"' and S.productID = '"+mediaID+"'";
						...
						while(rs.next())
	    				{
								...
								out.println("<tr><td colspan='2' style='font-size:24px; color:red'><h2>&#8377;&nbsp;" + rs.getString(10) + " /-</h2></td></tr><tr><td colspan='2'><hr size='1' width='100%' /></td></tr>");
								out.println("<tr><th class='feature'>Artists</th><td>" + rs.getString("artist") + "</td></tr>");
								out.println("<tr><th class='feature'>Category</th><td>" + rs.getString("category") + "</td></tr>");
								out.println("<tr><th class='feature'>Format</th><td>" + rs.getString("format") + "</td></tr>");
								out.println("<tr><th class='feature'>Language</th><td>" + rs.getString("language") + "</td></tr>");
								out.println("<tr><th class='feature'>Lable</th><td>" + rs.getString("lable") + "</td></tr>");
								out.println("<tr><th class='feature'>Genre</th><td>" + rs.getString("genre") + "</td></tr>");
		...
		%>
	    				...
	    				<table>
							<tr>
		 						<form method = 'POST' action="cart.jsp">
									<input type='hidden' name='IDD' value=<%= mediaID %>>
					...
					<%
    				String query2 = "select * from Sellers where productID = '"+ mediaID+"' order by price ASC";
    				String query3 = "select count(seller) from Sellers where productID = '"+ mediaID+"'";
    				...
    				out.println("<tr class='feature1'><th class='feature1'> Seller </th> <th class='feature1'> Price </th> <th class='feature1'> Shipping Price </th> <th class='feature1'> Total </th><th class='feature1'> Buy at </th>");
    				while(rs2.next())
    				{
    						out.println("<tr><td colspan='5'><hr noshade size='2' width='100%' /></td></tr>");
    						...
    						{
    							out.println("http://www.flipkart.com/search/a/movies-music?query="+name+"'> <input type = 'button' value = 'Flipkart'>");
    						}
    				...
    				out.println("<td colspan='6'><hr size='1' width='100%' /></td></table></center>");
