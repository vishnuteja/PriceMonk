...
<body>
		<%
			...
			{	
						...
						String query = "select P.title, P.RelDate, P.imgURL, B.*, min(S.price+S.SPrice) from Products P,Books B, Sellers S where P.productID = '" + bookID +"' and B.productID = '" + bookID +"' and S.productID = '"+bookID+"'";
						...
						while(rs.next())
	    				{
	    						...
	    						out.println("<tr><td colspan='2'><h1>" + rs.getString("title") + "</h1></td></tr>");
	    						out.println("<tr><td colspan='2'>By <span style='color:blue'><a href = 'author.jsp?Author=" + rs.getString("Author") + "'>"+rs.getString("Author")+"</a></span>  Author(s) </td></tr><tr><td colspan='2'><hr size='1' width='100%' /></td></tr>");
	    						out.println("<tr><td>Starts at</td></tr>");
	    						out.println("<tr><td colspan='2' style='font-size:24px; color:red'><h2>&#8377;&nbsp;" + rs.getString(13) + " /-</h2></td></tr><tr><td colspan='2'><hr size='1' width='100%' /></td></tr>");
	    						out.println("<tr><th class='feature'>Author</th><td>" + rs.getString("Author") + "</td></tr>");
	    						out.println("<tr><th class='feature'>Edition</th><td>" + rs.getString("Edition") + "</td></tr>");
	    						out.println("<tr><th class='feature'>Release Date</th><td>" + rs.getString("RelDate") + "</td></tr>");
	    						out.println("<tr><th class='feature'>Format</th><td>" + rs.getString(12) + "</td></tr>");
	    						out.println("<tr><th class='feature'>Publisher</th><td>" + rs.getString("publisher") + "</td></tr>");
	    						out.println("<tr><th class='feature'>Language</th><td>" + rs.getString("language") + "</td></tr>");
	    						out.println("<tr><th class='feature'>Pages</th><td>" + rs.getString("pages") + "</td></tr>");
	    						out.println("<tr><th class='feature'>ISBN 10</th><td>" + rs.getString("ISBN") + "</td></tr>");
	    						out.println("<tr><th class='feature'>ISBN 13</th><td>" + rs.getString("ISBN_N") + "</td></tr>");
	    						out.println("</td></table>");
	    						isbn = rs.getString("isbn");
	    						String IDD = rs.getString("productID");
	    						//out.println("<tr><td>Shipping Weight</td><td>" + rs.getString("SWeight") + "</td></tr>");
	    						//out.println("<tr><td>Rank</td><td>" + rs.getString("rank") + "</td></tr>");
	    				}
		...
		%>
	    				...
	    				<table>
							<tr>
		 						<form method = 'POST' action="cart.jsp">
									<input type='hidden' name='IDD' value=<%= bookID %>>
					...
					<%
    				String query2 = "select * from Sellers where productID = '"+ bookID+"' order by price ASC";
    				String query3 = "select count(seller) from Sellers where productID = '"+ bookID+"'";
    				...
    				out.println("<tr class='feature1'><th class='feature1'> Seller </th> <th class='feature1'> Price </th> <th class='feature1'> Shipping Price </th> <th class='feature1'> Total </th><th class='feature1'> Buy at </th></tr>");
    				...
    				while(rs2.next())
    				{
    						...
    						{
    							out.println("http://www.flipkart.com/books/"+isbn+"'> <input type = 'button' value = 'Flipkart'>");
    						}
